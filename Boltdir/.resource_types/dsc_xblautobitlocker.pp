...
Puppet::Resource::ResourceType3.new(
  ...
  [
    ...
    # DriveType - Valid values are Fixed, Removable.
    Puppet::Resource::Param(Any, 'dsc_drivetype'),

    # MinDiskCapacityGB
    Puppet::Resource::Param(Any, 'dsc_mindiskcapacitygb'),
    ...
    # The specific backend to use for this `dsc_xblautobitlocker`

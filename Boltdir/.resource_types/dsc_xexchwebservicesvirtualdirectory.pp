...
Puppet::Resource::ResourceType3.new(
  ...
  [
    ...
    Puppet::Resource::Param(Any, 'dsc_internalnlbbypassurl'),
    ...
    # 
    # Valid values are `true`, `false`.
    Puppet::Resource::Param(Variant[Boolean, Enum['true', 'false']], 'dsc_oauthauthentication'),
    ...
    # 
    # Valid values are `true`, `false`.
    Puppet::Resource::Param(Variant[Boolean, Enum['true', 'false']], 'dsc_wssecurityauthentication'),

    # The specific backend to use for this `dsc_xexchwebservicesvirtualdirectory`

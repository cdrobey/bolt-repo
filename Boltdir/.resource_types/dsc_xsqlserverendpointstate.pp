...
Puppet::Resource::ResourceType3.new(
  ...
  [
    ...
    # NodeName - The host name of the SQL Server to be configured. Default value is $env:COMPUTERNAME.
    Puppet::Resource::Param(Any, 'dsc_nodename'),

    # Name - The name of the endpoint.
    Puppet::Resource::Param(Any, 'dsc_name'),

    # State - The state of the endpoint. Valid states are Started, Stopped or Disabled. Default value is 'Started'. Valid values are Started, Stopped, Disabled.
    Puppet::Resource::Param(Any, 'dsc_state'),

    # The specific backend to use for this `dsc_xsqlserverendpointstate`

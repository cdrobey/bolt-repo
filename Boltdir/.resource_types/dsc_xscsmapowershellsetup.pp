...
Puppet::Resource::ResourceType3.new(
  ...
  [
    ...
    # Ensure - An enumerated value that describes if SMA PowerShell is expected to be installed on the machine.
    # Present {default}
    # Absent
    ...
    # The specific backend to use for this `dsc_xscsmapowershellsetup`

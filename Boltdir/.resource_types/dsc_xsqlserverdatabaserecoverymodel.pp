...
Puppet::Resource::ResourceType3.new(
  ...
  [
    ...
    # RecoveryModel - The recovery model to use for the database. Valid values are Full, Simple, BulkLogged.
    Puppet::Resource::Param(Any, 'dsc_recoverymodel'),
    ...
    # The specific backend to use for this `dsc_xsqlserverdatabaserecoverymodel`
